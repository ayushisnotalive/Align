...
**2026-09-20 note:** model tags are guidance only — proceed with whatever model is active in this workspace loop. AGENTS.md is the absolute canonical rulebook (not .cursorrules).
