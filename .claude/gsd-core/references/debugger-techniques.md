...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/ayushz/storage/CST studies/all projects/Align/.claude
                  → checks /home/ayushz/storage/CST studies/all projects/Align/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core
                  → writes to /home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/hooks/
