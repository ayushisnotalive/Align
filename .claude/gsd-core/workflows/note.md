...
- **Global scope**: `/home/ayushz/storage/CST studies/all projects/Align/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/ayushz/storage/CST studies/all projects/Align/.claude/notes/`)
...
2. Glob `/home/ayushz/storage/CST studies/all projects/Align/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/ayushz/storage/CST studies/all projects/Align/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/ayushz/storage/CST studies/all projects/Align/.claude/notes/` — works in any directory
