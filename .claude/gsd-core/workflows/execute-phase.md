...
@/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/agent-contracts.md
@/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/context-budget.md
@/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/gates.md
</required_reading>
...
@/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/execute-phase-response-language.md
...
- Executor agents omit extended deviation rule examples and checkpoint examples from inline prompt — load on-demand via @/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/executor-examples.md
- Planner agents omit extended anti-pattern lists and specificity examples from inline prompt — load on-demand via @/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/planner-antipatterns.md
...
```
Pure doc-only / config-only / test-only tasks return `is_behavior_adding=false` and are exempt. When the gate trips, Read `/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/execute-mvp-tdd.md` for the exact halt report format.
</step>
...
@/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/execute-phase-wave-guard.md

@/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/execute-phase-context-guard.md
   ...
   Agent(
    ...
    description="Execute plan {plan_number} of phase {phase_number}",
     ...
     prompt="
       ...
       - `/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/checkpoints.md`
       ${TDD_APPLICABLE ? '- `/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/tdd.md`' : ''}  # #3990/#4265: type: tdd, tdd="true", or workflow.tdd_mode
       - `/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/worktree-path-safety.md`
       ${CONTEXT_WINDOW < 200000 ? '' : '- `/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/executor-examples.md`'}
       </execution_context>
...
@/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/execute-phase-quota-recovery.md

@/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/execute-phase-between-wave-reset.md
...
**TDD review escalation (overrides the advisory default for the `tdd.review-checkpoint` gate only).** The tdd `execute:post` gate is declared `blocking: false`, so by the generic contract above it displays its `message`/table and continues. There is ONE documented exception (see `/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/execute-mvp-tdd.md`): when `TDD_MODE=true` AND `GATE_RESULT.block == true` (one or more TDD plans miss a RED or GREEN gate commit; #4011 — no MVP condition), the end-of-phase TDD review escalates from advisory to **blocking under TDD** — refuse to mark the phase complete and present:
...
**If gaps_found:**
@/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/execute-phase-requirement-revert.md
```
...
@/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/workflows/transition.md
</step>
