...
<required_reading>
@/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/user-story-template.md
@/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/spidr-splitting.md
@/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/spidr-splitting.md`. Briefly:
