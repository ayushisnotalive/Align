...
ones). Reference: @/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/ayushz/storage/CST studies/all projects/Align/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/ayushz/storage/CST studies/all projects/Align/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/templates/spec.md.
