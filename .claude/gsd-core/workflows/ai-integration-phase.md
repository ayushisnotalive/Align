...
<required_reading>
@/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/ai-frameworks.md
@/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/ayushz/storage/CST studies/all projects/Align/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/ayushz/storage/CST studies/all projects/Align/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/ayushz/storage/CST studies/all projects/Align/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/ayushz/storage/CST studies/all projects/Align/.claude/agents/gsd-eval-planner.md for instructions.
