...
```
Agent(
  prompt="Read /home/ayushz/storage/CST studies/all projects/Align/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/templates/VALIDATION.md`
