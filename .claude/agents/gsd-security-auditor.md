...
**Verification depth scales with `asvs_level`** (see @/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
