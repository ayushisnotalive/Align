...
**Verification depth scales with `asvs_level`** (full definitions: @/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/security-asvs-levels.md):
