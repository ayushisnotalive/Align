...
<required_reading>
@/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/verification-overrides.md
@/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/gates.md
@/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/verifier-phase-gates.md
@/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/verifier-evidence-gate.md
</required_reading>
...
@/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/few-shot-examples/verifier.md
...
**When the phase under verification has `mode: mvp` in ROADMAP.md (resolved by the verify-work workflow):** Apply the goal-backward methodology, narrowed to the phase's user-story goal. Required reading: `@/home/ayushz/storage/CST studies/all projects/Align/.claude/gsd-core/references/verify-mvp-mode.md`.
