...
Key references:
- @/home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/references/ui-brand.md (display patterns)
- @/home/ayushz/storage/CST studies/all projects/Align/.hermes/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/USER-PROFILE.md"
...
```bash
cp "/home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/USER-PROFILE.md" "/home/ayushz/storage/CST studies/all projects/Align/.hermes/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/USER-PROFILE.md
...
Use the Task tool to spawn the `gsd-user-profiler` agent, passing (omit the parameter per the rule above when the value is `"inherit"` or empty). Provide it with:
- The sampled JSONL file path from profile-sample output
- The user-profiling reference doc at `/home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/references/user-profiling.md`
...
Reference: @/home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global HERMES.md" -- "Add profile to /home/ayushz/storage/CST studies/all projects/Align/.hermes/HERMES.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /home/ayushz/storage/CST studies/all projects/Align/.hermes/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /home/ayushz/storage/CST studies/all projects/Align/.hermes/HERMES.md"
...
```bash
BACKUP_PATH="/home/ayushz/storage/CST studies/all projects/Align/.hermes/USER-PROFILE.backup.md"
```
...
Your profile:    /home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /home/ayushz/storage/CST studies/all projects/Align/.hermes/skills/gsd-dev-preferences/SKILL.md
  ✓ HERMES.md section       <resolved claude_md_path, default ./.hermes/HERMES.md>
  ✓ Global HERMES.md        /home/ayushz/storage/CST studies/all projects/Align/.hermes/HERMES.md
```

(Show the `claude_md_path` actually returned by the command — it defaults to `./.hermes/HERMES.md` but may be overridden by config or `--output`.)
