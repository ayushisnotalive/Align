...
<template>
@/home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/templates/UAT.md
</template>
...
Read and follow `/home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/workflows/transition.md`.
...
Exact delegate_task() prompt fields: `gsd-core/workflows/verify-work/detail/elaboration.md` § 2.
</step>
...
you used. Re-check locked decisions, capability guidance (HERMES.md, project skills) and the
...
Exact delegate_task() prompt fields (revision_context, required_reading): `gsd-core/workflows/verify-work/detail/elaboration.md` § 3.
</step>
