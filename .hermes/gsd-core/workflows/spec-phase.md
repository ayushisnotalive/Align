...
ones). Reference: @/home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/ayushz/storage/CST studies/all projects/Align/.hermes.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "$_GSD_RT/.hermes/bin/lib/edge-probe.cjs" \
  "/home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/ayushz/storage/CST studies/all projects/Align/.hermes/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/templates/spec.md.
