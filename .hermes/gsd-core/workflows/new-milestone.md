...
Use template: /home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/templates/research-project/{FILE}
</output>
", gsd_role="gsd-project-researcher", gsd_role_prompt=<resolve "gsd-project-researcher" against the active install's gsd-* role prompts and load its contents; FAIL CLOSED with an explicit error if unresolved — never execute the role inline>, role="leaf", description="{DIMENSION} research")
```
