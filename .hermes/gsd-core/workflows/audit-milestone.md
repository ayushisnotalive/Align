...
${AGENT_SKILLS_CHECKER}",
  gsd_role="gsd-integration-checker",
  gsd_role_prompt=<resolve "gsd-integration-checker" against the active install's gsd-* role prompts and load its contents; FAIL CLOSED with an explicit error if unresolved — never execute the role inline>,
