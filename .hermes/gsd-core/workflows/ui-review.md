...
```markdown
Read /home/ayushz/storage/CST studies/all projects/Align/.hermes/agents/gsd-ui-auditor.md for instructions.
...
delegate_task(
  ...
  gsd_role="gsd-ui-auditor",
  gsd_role_prompt=<resolve "gsd-ui-auditor" against the active install's gsd-* role prompts and load its contents; FAIL CLOSED with an explicit error if unresolved — never execute the role inline>,
