...
- Follow @/home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/workflows/diagnose-issues.md
...
orchestrator in the repo. This section adds only the surrounding `delegate_task()` scaffolding:
