...
```
delegate_task(
  prompt="Read /home/ayushz/storage/CST studies/all projects/Align/.hermes/agents/gsd-security-auditor.md for instructions.\n\n" +
  ...
  gsd_role="gsd-security-auditor",
  gsd_role_prompt=<resolve "gsd-security-auditor" against the active install's gsd-* role prompts and load its contents; FAIL CLOSED with an explicit error if unresolved — never execute the role inline>,
...
**State B (create):**
1. Read template from `/home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/templates/SECURITY.md`
