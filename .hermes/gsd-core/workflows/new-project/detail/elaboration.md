...
```text
delegate_task(prompt="<research_type>
...
Use template: /home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/templates/research-project/STACK.md
</output>
", gsd_role="gsd-project-researcher", gsd_role_prompt=<resolve "gsd-project-researcher" against the active install's gsd-* role prompts and load its contents; FAIL CLOSED with an explicit error if unresolved — never execute the role inline>, role="leaf", description="Stack research")
...
Use template: /home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/templates/research-project/FEATURES.md
</output>
", gsd_role="gsd-project-researcher", gsd_role_prompt=<resolve "gsd-project-researcher" against the active install's gsd-* role prompts and load its contents; FAIL CLOSED with an explicit error if unresolved — never execute the role inline>, role="leaf", description="Features research")
...
Use template: /home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/templates/research-project/ARCHITECTURE.md
</output>
", gsd_role="gsd-project-researcher", gsd_role_prompt=<resolve "gsd-project-researcher" against the active install's gsd-* role prompts and load its contents; FAIL CLOSED with an explicit error if unresolved — never execute the role inline>, role="leaf", description="Architecture research")
...
Use template: /home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/templates/research-project/PITFALLS.md
</output>
", gsd_role="gsd-project-researcher", gsd_role_prompt=<resolve "gsd-project-researcher" against the active install's gsd-* role prompts and load its contents; FAIL CLOSED with an explicit error if unresolved — never execute the role inline>, role="leaf", description="Pitfalls research")
```

(The "wait for all 4 researchers before spawning the synthesizer" orchestrator rule, the full
synthesizer `delegate_task()` call, and the entire #222 self-heal recovery sequence — including its log
