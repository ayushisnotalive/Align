...
```markdown
Read /home/ayushz/storage/CST studies/all projects/Align/.hermes/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/templates/UI-SPEC.md
</output>
...
delegate_task(
  ...
  gsd_role="gsd-ui-researcher",
  gsd_role_prompt=<resolve "gsd-ui-researcher" against the active install's gsd-* role prompts and load its contents; FAIL CLOSED with an explicit error if unresolved — never execute the role inline>,
...
```markdown
Read /home/ayushz/storage/CST studies/all projects/Align/.hermes/agents/gsd-ui-checker.md for instructions.
...
delegate_task(
  ...
  gsd_role="gsd-ui-checker",
  gsd_role_prompt=<resolve "gsd-ui-checker" against the active install's gsd-* role prompts and load its contents; FAIL CLOSED with an explicit error if unresolved — never execute the role inline>,
  role="leaf",  # nested delegation is unavailable at this dispatch depth/toolkit
...
you used. Re-check the user's locked answers, capability guidance (HERMES.md, project skills) and
...
@/home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /home/ayushz/storage/CST studies/all projects/Align/.hermes.
...
UI_PROBE_JS=$(for _c in \
  ...
  "$_GSD_RT/.hermes/bin/lib/ui-consideration-probe.cjs" \
  "/home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/home/ayushz/storage/CST studies/all projects/Align/.hermes/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
