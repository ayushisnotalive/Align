 ...
 *                                                      runtime's config dir (e.g. driving Hermes Agent from a
...
// prebuilt in the npm tarball. The Hermes Agent plugin-marketplace channel never
...
// is removed at cutover so it reaches here; an unmigrated command still hits
  ...
  // if argv > 32,767 chars — HERMES.md "Windows ARGV Overflow"). A pin over
