 ...
 * can never diverge — see HERMES.md's "Generative Fix Divergence" note: this
 ...
 * normalization — HERMES.md's Generative Fix Divergence class):
 ...
 * re-derived per site (HERMES.md's Generative Fix Divergence class).
