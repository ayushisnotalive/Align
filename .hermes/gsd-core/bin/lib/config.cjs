...
function buildNewProjectConfig(userChoices) {
    ...
    const hardcoded = {
        ...
        agent_skills: {},
        claude_md_path: './.hermes/HERMES.md',
        plan_review: {
    ...
    // Hermes Agent projects, resolving agents to wrong model IDs. `resolve_model_ids`
 ...
 * same try/catch (HERMES.md's "Generative Fix Divergence" known-defect
