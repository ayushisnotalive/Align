...
The keys live in `.hermes/settings.json` (project) or `/home/ayushz/storage/CST studies/all projects/Align/.hermes/settings.json` (global) — **not** in `.planning/config.json`:
...
See @/home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/references/planner-guidance.md for Granularity Calibration table (Coarse/Standard/Fine plans-per-phase).
