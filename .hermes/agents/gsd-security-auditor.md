...
**Verification depth scales with `asvs_level`** (see @/home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/references/security-asvs-levels.md for full definitions):
