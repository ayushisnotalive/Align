...
<project_context>
Before verifying: read `./HERMES.md` if present, follow project-specific guidelines.

Check `.hermes/skills/` or `.agents/skills/` if either exists.

**agent_skills:** self-load per @/home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/references/agent-skills-bootstrap.md — list
