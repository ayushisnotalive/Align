...
**Project skills:** check `.hermes/skills/` or `.agents/skills/` if either exists.

**agent_skills:** self-load per @/home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/references/agent-skills-bootstrap.md — list skill subdirs, read each `SKILL.md` (~130-line index), load `rules/*.md` as needed. NEVER load full `AGENTS.md` (100KB+ cost). Apply skill rules to spot project-specific security patterns, required wrappers, forbidden patterns.
</step>
...
**Verification depth scales with `asvs_level`** (full definitions: @/home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/references/security-asvs-levels.md):
