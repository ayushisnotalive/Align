...
if [ "$USE_WORKTREES" = "false" ]; then
  ...
  # #2647: create the worktree INSIDE the repo under the same `.hermes/worktrees/`
  ...
  # `.gitignore` rule for `.hermes/` (`.gitignore:12`). Uniqueness across
  ...
  wt="$main_repo/.hermes/worktrees/rf-${padded_phase}-$$-$(date +%s)"
  mkdir -p "$wt"
