...
<project_context>
Read `./HERMES.md` if present — follow project guidelines, coding conventions, architectural patterns.

**Project skills:** check `.hermes/skills/` or `.agents/skills/`: list skill subdirectories, read each `SKILL.md` (lightweight index ~130 lines), load specific `rules/*.md` as needed. Do NOT load full `AGENTS.md` files (100KB+ context cost).
</project_context>
