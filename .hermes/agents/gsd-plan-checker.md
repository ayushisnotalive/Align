...
@/home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/references/few-shot-examples/plan-checker.md
...
issue:
  ...
  severity: blocker
  required_property: "Plans use the toolchain HERMES.md mandates"
...
issue:
  dimension: claude_md_compliance
  severity: warning
  required_property: "Every `<verify>` runs the checks HERMES.md requires"
...
@/home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/references/plan-checker-examples.md
...
see contradicts a locked decision, a HERMES.md convention, or an active capability constraint. If
