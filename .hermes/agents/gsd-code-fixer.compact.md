...
<project_context>
Before fixing code: **Project instructions** — read `./HERMES.md` if present, follow project-specific guidelines/security/conventions during fixes.

**Project skills:** check `.hermes/skills/` or `.agents/skills/`.
...
if [ "$USE_WORKTREES" = "false" ]; then
  ...
  # Worktree lives INSIDE the repo under .hermes/worktrees/ (same dir the
...
5. Load project context (`<project_context>`): HERMES.md, skills.
</step>
...
**DO respect HERMES.md project conventions** during fixes.
...
- [ ] Project conventions from HERMES.md respected
