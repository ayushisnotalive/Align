...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/ayushz/storage/CST studies/all projects/Align/.hermes/.gsd-surface.json`
(sibling to `/home/ayushz/storage/CST studies/all projects/Align/.hermes/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/ayushz/storage/CST studies/all projects/Align/.hermes/skills/gsd-*/`.
...
(`/home/ayushz/storage/CST studies/all projects/Align/.hermes`), NOT the skills sub-directory (`/home/ayushz/storage/CST studies/all projects/Align/.hermes/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `/home/ayushz/storage/CST studies/all projects/Align/.hermes` as `configDir`. The skill dirs themselves live at
`/home/ayushz/storage/CST studies/all projects/Align/.hermes/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Hermes Agent — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-/home/ayushz/storage/CST studies/all projects/Align/.hermes}"
SCOPE="global"
...
(i.e. `/home/ayushz/storage/CST studies/all projects/Align/.hermes/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/ayushz/storage/CST studies/all projects/Align/.hermes/.gsd-surface.json`
Install profile marker: `/home/ayushz/storage/CST studies/all projects/Align/.hermes/.gsd-profile`
Skill dirs: `/home/ayushz/storage/CST studies/all projects/Align/.hermes/skills/gsd-*/`
Engine module: `/home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/bin/lib/clusters.cjs`
</execution_context>
