...
<execution_context>
@/home/ayushz/storage/CST studies/all projects/Align/.hermes/gsd-core/workflows/code-review.md
</execution_context>
...
Context files (HERMES.md, SUMMARY.md, phase state) are resolved inside the workflow via `gsd-tools query init.phase-op` and delegated to agent via `<required_reading>` blocks.
</context>
