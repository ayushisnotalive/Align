...
// build failure must degrade to a blank line rather than break Hermes Agent's
...
// Hermes Agent's per-render statusline hook. Scoped to the spawned-as-a-script
 ...
 * cache-read, and output tokens (the same total Hermes Agent's /context shows).
...
/**
 * Collapse the verbose " (… context)" model-name suffix Hermes Agent sends for
